...
class TPromoSlider2 extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Obx(
        ...
        // No data found
        if (controller.banners2.isEmpty) {
                ...
                child: Obx(
                      ...
                      Row(
                        ...
                        children: [
                          ...
                          for (int i = 0; i < controller.banners2.length; i++)
                            TCircularContainer(
                              width: 20,
                              height: 4,
