    ...
    return PopScope(
      ...
      child: DefaultTabController(
        ...
        child: Scaffold(
          ...
          appBar: TAppBar(
            title: Text('Store'.tr, style: Theme.of(context).textTheme.headlineMedium),
                  ...
                  flexibleSpace: Padding(
                    ...
                    child: ListView(
                      ...
                      children: [
                        ...
                        TSearchContainer(text: 'Search in Store'.tr, showBorder: true, showBackground: false, padding: EdgeInsets.zero),
                        const SizedBox(height: TSizes.spaceBtwSections),

                        /// -- Featured Brands
                        TSectionHeading(title: 'Featured Brands'.tr, onPressed: () => Get.to(() => const AllBrandsScreen())),
                        ...
                        Obx(
                            ...
                            if (brandController.featuredBrands.isEmpty) {
                              return Center(
                                  child: Text('No Data Found!'.tr, style: Theme.of(context).textTheme.bodyMedium!.apply(color: Colors.white)));
                            } else {
                              /// Data Found
                              return TGridLayout(
                                itemCount: 4,
