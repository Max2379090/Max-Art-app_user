        ...
        title: Column(
          children: [
            Row(
              ...
              children: [
                const Text("ORANGE Recharge/Airtime"),
                const SizedBox(height: 40), // Space between texts
              ],
            ),
            Text("ORANGE communication credit recharge", style: TextStyle(fontSize: 13.5, color: Colors.grey[350])),
          ],
        ),
        centerTitle: true,
      ),
                ...
                itemBuilder: (context, index) {
                  ...
                  return ListTile(
                    leading: ClipRRect(
                      ...
                      child: Image.asset(
                        'assets/images/banners/Orange_logo.jpg',
                        width: 50,
                        height: 50,
                      ),
                    ),
                                    ...
                                    children: [
                                            ...
                                            child: Row(
                                              children: [
                                                ClipRRect(
                                                  ...
                                                  child: Image.asset(
                                                    'assets/images/banners/Orange_logo.jpg', // Replace with your image URL
                                      ...
                                      Row(
                                        children: [
                                          ...
                                          Expanded(
                                            child: const Text(
                                              "Enter phone number in the format 690#######. The Minimum amount for this is 100 FCFA",
