...
class YoomeePage extends StatelessWidget {
  YoomeePage({super.key});

  final List<Map<String, String>> subscriptions = [
    {"title": "Yoomee 10000 XAF", "price": "10000 XAF"},
    {"title": "Yoomee 5000 XAF", "price": "5000 XAF"},
    {"title": "Yoomee 4000 XAF", "price": "4000 XAF"},
    {"title": "Yoomee 3000 XAF", "price": "3000 XAF"},
    {"title": "Yoomee 2000 XAF", "price": "2000 XAF"},
    {"title": "Yoomee 1500 XAF", "price": "1500 XAF"},
    {"title": "Yoomee 1000 XAF", "price": "1000 XAF"},
    {"title": "Yoomee 500 XAF", "price": "500 XAF"},
    {"title": "Yoomee 300 XAF", "price": "300 XAF"},
    {"title": "Yoomee 200 XAF", "price": "200 XAF"},
    {"title": "Yoomee 100 XAF", "price": "100 XAF"},
        ...
        title: Column(
          children: [
            Row(
              ...
              children: [
                const Text("Yoomee Recharge/Topup"),
                const SizedBox(height: 40), // Space between texts
              ],
            ),
            Text("Yoomee communication credit recharge", style: TextStyle(fontSize: 13.5, color: Colors.grey[350])),
          ],
        ),
        centerTitle: true,
      ),
                ...
                itemBuilder: (context, index) {
                  ...
                  return ListTile(
                    leading: ClipRRect(
                      ...
                      child: Image.asset(
                        'assets/images/banners/YOOME_logo copie.jpg',
                        width: 50,
                        height: 50,
                      ),
                    ),
                                            ...
                                            child: Row(
                                              children: [
                                                ClipRRect(
                                                  ...
                                                  child: Image.asset(
                                                    'assets/images/banners/YOOME_logo copie.jpg', // Replace with your image URL
