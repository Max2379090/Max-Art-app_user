...
class CheckoutController extends GetxController {
  ...
  @override
  void onInit() {
    selectedPaymentMethod.value = PaymentMethodModel(name: PaymentMethods.Orange.name, image: TImages.orangeMoney);
    super.onInit();
  }
        ...
        child: Container(
          ...
          child: Column(
            ...
            children: [
              ...
              TPaymentTile(paymentMethod: PaymentMethodModel(name: PaymentMethods.Orange.name, image: TImages.orangeMoney)),
              const SizedBox(height: TSizes.spaceBtwItems / 2),
              TPaymentTile(paymentMethod: PaymentMethodModel(name:PaymentMethods.MTN.name, image: TImages.mtnMomo)),
              //const SizedBox(height: TSizes.spaceBtwItems / 2),
  ...
  bool isShippingFree(double subTotal) {
    if (settingsController.settings.value.freeShippingThreshold != null && settingsController.settings.value.freeShippingThreshold! > 0) {
