  ...
  void addToCart(ProductModel product) {
    ...
    if (product.productType == ProductType.variable.toString()) {
      if (variationController.selectedVariation.value.stock < 1) {
        TLoaders.warningSnackBar(message: 'Selected variation is out of stock.'.tr, title: 'Oh Snap!'.tr);
        return;
      }
    } else {
      if (product.stock < 1) {
        TLoaders.warningSnackBar(message: 'Selected Product is out of stock.'.tr, title: 'Oh Snap!'.tr);
        return;
      }
    }
    ...
    updateCart();
    TLoaders.customToast(message: 'Your Product has been added to the Cart.'.tr);
  }
