...
class AddressController extends GetxController {
            ...
            children: [
             TSectionHeading(title: 'Select Address'.tr, showActionButton: false),
              ...
              SizedBox(
                ...
                child: ElevatedButton(onPressed: () => Get.to(() => const AddNewAddressScreen()), child:Text('Add new address'.tr)),
              ),
            ],
          ),
        ),
  ...
  updateAddress(AddressModel oldAddress) async {
    try {
      // Start Loading
      TFullScreenLoader.openLoadingDialog('Updating your Address...'.tr, TImages.docerAnimation);
      ...
      // Show Success Message
      TLoaders.successSnackBar(title: 'Congratulations'.tr, message: 'Your address has been updated successfully.'.tr);
      ...
      // Remove Loader
      TFullScreenLoader.stopLoading();
      TLoaders.errorSnackBar(title: 'Error Updated Address'.tr, message: e.toString());
    }
  }
