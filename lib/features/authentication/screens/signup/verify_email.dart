        ...
        child: Padding(
          ...
          child: Column(
            children: [
              ...
              Text(TTexts.confirmEmail.tr, style: Theme.of(context).textTheme.headlineMedium, textAlign: TextAlign.center),
              ...
              SizedBox(
                ...
                child: ElevatedButton(onPressed: () => controller.checkEmailVerificationStatus(), child:Text(TTexts.tContinue.tr)),
              ),
              const SizedBox(height: TSizes.spaceBtwItems),
              ...
              SizedBox(
                width: double.infinity,
                child: TextButton(onPressed: () => controller.sendEmailVerification(), child: Text(TTexts.resendEmail.tr)),
              ),
            ],
          ),
        ),
